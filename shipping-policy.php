...
<head>
    ...
    <script type="application/ld+json">
            {
              ...
              "@type": "<?php echo htmlspecialchars($store_name); ?> - Shipping policy",
              "mainEntity": {
                "@type": "Organization",
    ...
    <title><?php echo htmlspecialchars($store_name); ?> - Shipping policy</title>
...
<body class="bg-gray-50">
    ...
    <div class="privacy-policy">
        ...
        $settings = $websiteEdite->shipping_policy();

        if ($settings) {
            $shipping_policy = $settings['shipping_policy'];

        } else {
            $shipping_policy = "Error , please load the page";
