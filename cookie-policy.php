...
<head>
    ...
    <script type="application/ld+json">
            {
              ...
              "@type": "<?php echo htmlspecialchars($store_name); ?> - Cookie Policy",
              "mainEntity": {
                "@type": "Organization",
    ...
    <title><?php echo htmlspecialchars($store_name); ?> - Cookie Policy</title>
...
<body class="bg-gray-50">
    ...
    <div class="privacy-policy">
        ...
        $settings = $websiteEdite->Affcihe_cookie();
